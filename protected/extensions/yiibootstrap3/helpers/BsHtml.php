...
EOD;
    ...
    public static function checkBoxControlGroup($name, $checked = false, $htmlOptions = array())
    {
        ...
        if ($layout === BsHtml::FORM_LAYOUT_HORIZONTAL) {
            ...
            $output .= parent::openTag('div', array('class' => self::$formLayoutHorizontalOffsetClass . ' ' . self::$formLayoutHorizontalControlClass));
...
//        }
    ...
    public static function activeRadioButtonControlGroup($model, $attribute, $htmlOptions = array())
    {
        ...
        $header = $layout === BsHtml::FORM_LAYOUT_HORIZONTAL ? '<div class="form-group"><div class="' . self::$formLayoutHorizontalOffsetClass . '"><div class="radio"><label>' : '<div class="radio"><label>';
        $output = $header;
        $output .= $input;
    ...
    public static function formActions($actions, $htmlOptions = array())
    {
        ...
        $outPut .= parent::tag('div', array('class' => self::$formLayoutHorizontalOffsetClass . ' ' . self::$formLayoutHorizontalControlClass), $actions);
