 ...
 *
 * The followings are the available columns in table 'traslados':
 * @property string $id
 ...
 * @property DetalleTralados[] $detalleTraladoses
 */
class Traslados extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'detalleTraladoses' => array(self::HAS_MANY, 'DetalleTralados', 'traslado_id'),
		);
	}
	 ...
	 * @return Traslados the static model class
	 */
