...
class ProveedorInsumoController extends Controller
{
	...
	*/
	...
	{
		$model=new ProveedorInsumo;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProveedorInsumo']))
		{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('ProveedorInsumo');
	...
	*/
	...
	{
		$model=new ProveedorInsumo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProveedorInsumo']))
			$model->attributes=$_GET['ProveedorInsumo'];
	...
	* @return ProveedorInsumo the loaded model
	* @throws CHttpException
	*/
	public function loadModel($id)
	{
		$model=ProveedorInsumo::model()->findByPk($id);
		if($model===null)
